    ...
    return (
      <div className="min-h-screen bg-papier flex items-center justify-center p-6">
        <div className="card p-8 text-center max-w-sm">
          <div className="font-display font-semibold text-ardoise mb-2">Lien introuvable</div>
          <p className="text-sm text-ardoise/50">Ce lien de suivi n'est plus valide. Contactez votre entreprise d'étanchéité.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-papier">
      ...
      <div className="max-w-2xl mx-auto px-6 py-8 flex flex-col gap-6">
        <div className="card p-6 flex items-center justify-between">
          <div>
            <div className="text-xs text-ardoise/50 mb-1">Avancement global</div>
        ...
        {zones.length > 0 && (
          <div className="card p-6">
            <div className="font-medium text-ardoise mb-3">Zones</div>
            <div className="flex flex-col divide-y divide-ligne">
              {zones.map((z: any, i: number) => (
                <div key={i} className="flex items-center justify-between py-2 text-sm">
                  <span className="text-ardoise">{z.nom}</span>
        ...
        {photos.length > 0 && (
          <div className="card p-6">
            <div className="font-medium text-ardoise mb-3">Dernières photos</div>
        ...
        <p className="text-xs text-ardoise/40 text-center">Ce lien est personnel — ne le partagez pas.</p>
      </div>
    </div>
  );
}
